...
export default {
  ...
  preview: {
    ...
    loadFailed: '加载失败',
    // 转码集成
    checkingFingerprint: '正在检查文件...',
    alreadyTranscoded: '该视频已转码完成',
    alreadyTranscodedDesc: '可以直接播放，也可以选择重新转码。',
    playDirectly: '直接播放',
    reTranscode: '重新转码',
    loadingMetadata: '正在获取媒体信息...',
    selectTracks: '选择轨道',
    audioTrack: '音频轨道',
    subtitleTrack: '字幕轨道',
    noSubtitle: '不提取字幕',
    startTranscode: '开始转码',
    transcodeSubmitted: '转码任务已提交',
    transcodeSubmitFailed: '提交转码任务失败',
    transcodingProgress: '转码进度',
    stageAudioExtract: '音频提取',
    stageHLSPackage: 'HLS 封装',
    transcodeComplete: '转码完成',
    playNow: '立即播放',
    transcodeFailed: '转码失败',
    transcodeCancelled: '转码已取消',
    transcoding: '转码中',
    waitingTranscode: '等待转码',
    minimized: '转码任务已最小化，点击悬浮按钮查看进度',
    // 字幕
    extractSubtitle: '提取字幕',
    extractingSubtitle: '正在提取字幕...',
    subtitleExtracted: '字幕提取完成',
    subtitleExtractFailed: '字幕提取失败',
    localSubtitle: '本地字幕',
    embeddedSubtitle: '内嵌字幕',
    switchSubtitle: '切换字幕',
    noSubtitleTrack: '无字幕轨道',
  ...
  transcode: {
    ...
    confirmRetry: '确定要重试此任务吗？',
    confirmDelete: '确定要删除此任务吗？相关文件也将被清除。',
    confirmDeleteAll: '确定要删除所有转码任务吗？此操作不可撤销。',
    // 提示信息
    createSuccess: '转码任务创建成功',
    createFailed: '创建转码任务失败',
    stopSuccess: '任务已停止',
    stopFailed: '停止任务失败',
    retrySuccess: '任务已重新提交',
    retryFailed: '重试任务失败',
    deleteSuccess: '任务已删除',
    deleteFailed: '删除任务失败',
    deleteAllSuccess: '所有任务已删除',
    deleteAllFailed: '删除所有任务失败',
    fetchFailed: '获取转码数据失败',
    // 创建表单
    videoPathLabel: '视频文件路径',
    videoPathPlaceholder: '请输入视频文件路径',
    audioTrackLabel: '音频轨道索引',
    subtitleTrackLabel: '字幕轨道索引',
    immediateLabel: '即时观看',
    immediateHint: '优先处理此任务以便立即播放',
    fingerprintLabel: '视频指纹',
    fingerprintPlaceholder: '可选，留空自动生成',
    // 详情
    taskDetail: '任务详情',
    basicInfo: '基本信息',
    progressInfo: '进度信息',
