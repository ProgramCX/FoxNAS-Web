...
export default {
  ...
  monitor: {
    title: '系統監控',
    subtitle: '查看系統效能指標歷史資料',
    cpuUsage: 'CPU 使用率',
    memoryUsage: '記憶體使用率',
    networkSpeed: '網路速度',
    networkTraffic: '網路流量累計',
    diskUsage: '磁碟使用率',
    upload: '上傳',
    download: '下載',
    uploadTotal: '上傳累計',
  ...
  preview: {
    ...
    directDownload: '直接下載',
    playbackIssue: '播放相容性',
    videoNotNativeSupport: '該影片格式可能無法在瀏覽器中原生播放',
    audioNotNativeSupport: '該音訊格式可能無法在瀏覽器中原生播放',
    tryPlay: '嘗試播放',
    serverTranscode: '伺服器轉碼',
    transcodeNotAvailable: '伺服器轉碼功能尚未實現',
    loadFailed: '載入失敗',
  },
  ...
  transcode: {
    ...
    createTask: '建立任務',
    refreshList: '重新整理',
    confirmStop: '確定要停止此任務嗎？',
    confirmRetry: '確定要重試此任務嗎？',
    confirmDelete: '確定要刪除此任務嗎？相關檔案也將被清除。',
    confirmDeleteAll: '確定要刪除所有轉碼任務嗎？此操作不可撤銷。',
    createSuccess: '轉碼任務建立成功',
    createFailed: '建立轉碼任務失敗',
    stopSuccess: '任務已停止',
    stopFailed: '停止任務失敗',
    retrySuccess: '任務已重新提交',
    retryFailed: '重試任務失敗',
    deleteSuccess: '任務已刪除',
    deleteFailed: '刪除任務失敗',
    deleteAllSuccess: '所有任務已刪除',
    deleteAllFailed: '刪除所有任務失敗',
    fetchFailed: '獲取轉碼數據失敗',
    videoPathLabel: '影片檔案路徑',
    videoPathPlaceholder: '請輸入影片檔案路徑',
    audioTrackLabel: '音訊軌道索引',
    subtitleTrackLabel: '字幕軌道索引',
    immediateLabel: '即時觀看',
    immediateHint: '優先處理此任務以便立即播放',
    fingerprintLabel: '影片指紋',
    fingerprintPlaceholder: '可選，留空自動生成',
    taskDetail: '任務詳情',
    basicInfo: '基本資訊',
    progressInfo: '進度資訊',
    fileInfo: '檔案資訊',
    currentStage: '當前階段',
    totalStages: '總階段數',
    stageProgress: '第 {current} / {total} 階段',
    noTasks: '暫無轉碼任務',
    filterAll: '全部',
