...
export default {
  ...
  monitor: {
    ...
    subtitle: 'View system performance metrics history',
    cpuUsage: 'CPU Usage',
    memoryUsage: 'Memory Usage',
    networkSpeed: 'Network Speed',
    networkTraffic: 'Network Traffic Total',
    diskUsage: 'Disk Usage',
    upload: 'Upload',
    download: 'Download',
    ...
    endTime: 'End Time',
    export: 'Export',
    exportSingle: 'Export Single Chart',
  ...
  preview: {
    ...
    selectLyrics: 'Select Lyrics File',
    clearLyrics: 'Clear Lyrics',
    noLyrics: 'No Lyrics',
    code: 'Code',
    cannotPreview: 'Cannot Preview',
    chooseAction: 'Choose how to open:',
    openAsVideo: 'Open as Video',
    openAsAudio: 'Open as Audio',
    openAsText: 'Open as Text',
    openAsPdf: 'Open as PDF',
    directDownload: 'Direct Download',
    playbackIssue: 'Playback Compatibility',
    videoNotNativeSupport: 'This video format may not be natively supported by the browser',
    audioNotNativeSupport: 'This audio format may not be natively supported by the browser',
    tryPlay: 'Try Playing',
    serverTranscode: 'Server Transcode',
    transcodeNotAvailable: 'Server transcoding is not available yet',
    loadFailed: 'Load Failed',
    // Transcode integration
    checkingFingerprint: 'Checking file...',
    alreadyTranscoded: 'Video already transcoded',
    alreadyTranscodedDesc: 'You can play it directly or choose to re-transcode.',
    playDirectly: 'Play Directly',
    reTranscode: 'Re-transcode',
    loadingMetadata: 'Loading media info...',
    selectTracks: 'Select Tracks',
    audioTrack: 'Audio Track',
    subtitleTrack: 'Subtitle Track',
    noSubtitle: 'No Subtitle',
    startTranscode: 'Start Transcode',
    transcodeSubmitted: 'Transcode task submitted',
    transcodeSubmitFailed: 'Failed to submit transcode task',
    transcodingProgress: 'Transcode Progress',
    stageAudioExtract: 'Audio Extraction',
    stageHLSPackage: 'HLS Packaging',
    transcodeComplete: 'Transcode Complete',
    playNow: 'Play Now',
    transcodeFailed: 'Transcode Failed',
    transcodeCancelled: 'Transcode Cancelled',
    transcoding: 'Transcoding',
    waitingTranscode: 'Waiting for Transcode',
    minimized: 'Transcode task minimized, click the floating button to view progress',
    // Subtitles
    extractSubtitle: 'Extract Subtitle',
    extractingSubtitle: 'Extracting subtitle...',
    subtitleExtracted: 'Subtitle extraction complete',
    subtitleExtractFailed: 'Subtitle extraction failed',
    localSubtitle: 'Local Subtitle',
    embeddedSubtitle: 'Embedded Subtitle',
    switchSubtitle: 'Switch Subtitle',
    noSubtitleTrack: 'No subtitle tracks',
  ...
  transcode: {
    ...
    subtitle: 'Manage video transcoding tasks, view progress and status',
    // Statistics
    ...
    confirmDelete: 'Are you sure you want to delete this task? Related files will also be removed.',
    confirmDeleteAll: 'Are you sure you want to delete ALL transcode tasks? This action cannot be undone.',
    // Messages
    createSuccess: 'Transcode task created successfully',
    createFailed: 'Failed to create transcode task',
    stopSuccess: 'Task stopped successfully',
    stopFailed: 'Failed to stop task',
    retrySuccess: 'Task resubmitted successfully',
    retryFailed: 'Failed to retry task',
    deleteSuccess: 'Task deleted successfully',
    deleteFailed: 'Failed to delete task',
    deleteAllSuccess: 'All tasks deleted successfully',
    deleteAllFailed: 'Failed to delete all tasks',
    fetchFailed: 'Failed to fetch transcode data',
    // Create form
    videoPathLabel: 'Video File Path',
    videoPathPlaceholder: 'Enter video file path',
    audioTrackLabel: 'Audio Track Index',
    subtitleTrackLabel: 'Subtitle Track Index',
    immediateLabel: 'Immediate Watch',
    immediateHint: 'Prioritize this task for immediate playback',
    fingerprintLabel: 'Video Fingerprint',
    fingerprintPlaceholder: 'Optional, auto-generated if empty',
    // Detail
