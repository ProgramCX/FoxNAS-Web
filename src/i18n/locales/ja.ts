...
export default {
  ...
  preview: {
    ...
    clearSubtitle: '字幕をクリア',
    selectLyrics: '歌詞ファイルを選択',
    clearLyrics: '歌詞をクリア',
    noLyrics: '歌詞なし',
    code: 'コード',
    cannotPreview: 'プレビューできません',
    chooseAction: '開く方法を選択：',
    openAsVideo: '動画として開く',
    openAsAudio: '音声として開く',
    ...
    playbackIssue: '再生互換性',
    videoNotNativeSupport: 'この動画形式はブラウザでネイティブにサポートされていない可能性があります',
    audioNotNativeSupport: 'この音声形式はブラウザでネイティブにサポートされていない可能性があります',
    tryPlay: '再生を試す',
    serverTranscode: 'サーバートランスコード',
    transcodeNotAvailable: 'サーバートランスコードはまだ利用できません',
    loadFailed: '読み込み失敗',
  },
  ...
  transcode: {
    title: 'トランスコード管理',
    subtitle: 'ビデオトランスコードタスクの管理、進捗とステータスの確認',
    statistics: '統計概要',
    totalTasks: '総タスク数',
    pendingTasks: '待機中',
    processingTasks: '処理中',
    ...
    createTask: 'タスク作成',
    refreshList: '更新',
    confirmStop: 'このタスクを停止してよろしいですか？',
    confirmRetry: 'このタスクをリトライしてよろしいですか？',
    confirmDelete: 'このタスクを削除してよろしいですか？関連ファイルも削除されます。',
    confirmDeleteAll: 'すべてのトランスコードタスクを削除してよろしいですか？この操作は取り消せません。',
    createSuccess: 'トランスコードタスクが作成されました',
    createFailed: 'タスクの作成に失敗しました',
    stopSuccess: 'タスクが停止されました',
    stopFailed: 'タスクの停止に失敗しました',
    retrySuccess: 'タスクが再送信されました',
    retryFailed: 'リトライに失敗しました',
    deleteSuccess: 'タスクが削除されました',
    deleteFailed: '削除に失敗しました',
    deleteAllSuccess: 'すべてのタスクが削除されました',
    deleteAllFailed: 'すべてのタスクの削除に失敗しました',
    fetchFailed: 'データの取得に失敗しました',
    videoPathLabel: '動画ファイルパス',
    videoPathPlaceholder: '動画ファイルパスを入力',
    audioTrackLabel: '音声トラックインデックス',
    subtitleTrackLabel: '字幕トラックインデックス',
    immediateLabel: '即時視聴',
    immediateHint: '即時再生のためにこのタスクを優先する',
    fingerprintLabel: '動画フィンガープリント',
    fingerprintPlaceholder: 'オプション、空の場合は自動生成',
    taskDetail: 'タスク詳細',
    basicInfo: '基本情報',
    progressInfo: '進捗情報',
    fileInfo: 'ファイル情報',
    ...
    totalStages: '総ステージ数',
    stageProgress: 'ステージ {current} / {total}',
    noTasks: 'トランスコードタスクはありません',
    filterAll: 'すべて',
